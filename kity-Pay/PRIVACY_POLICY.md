...
Welcome to Kity Pay, a financial application operated by TekJuice. We are committed to protecting your privacy and personal information. This Privacy Policy explains how we collect, use, store, and protect your information when you use our mobile application and services.
...
- We request camera permission to enable:
  ...
  - QR code scanning for cryptocurrency transactions
...
- We request contacts permission to:
  - Help you easily send money to contacts
  - Facilitate bill payments to saved payees
...
- We use notifications to:
  - Alert you about transaction confirmations
...
- Processing cryptocurrency deposits and withdrawals
...
- Complying with financial regulations and AML requirements
- Monitoring for suspicious activities
- Securing your account and transactions

### 3.3 Communication and Support

- Sending transaction confirmations and receipts
- Providing customer support and assistance
- Delivering important account notifications
- Sharing product updates and security alerts
...
- Segregated storage of financial information
- Real-time fraud detection systems
- Secure API connections with financial partners
...
- Some transaction records may be retained longer for compliance
...
Your information may be processed and stored in countries other than your residence. We ensure appropriate safeguards are in place to protect your data during international transfers, including:
...
**Important:** This Privacy Policy should be reviewed by legal counsel familiar with financial services regulations and data protection laws in your jurisdiction before implementation. Consider adding jurisdiction-specific clauses as needed.
