...
- For premium or plus accounts, subscriptions are processed through third-party payment providers, which may include Google Play Billing and other authorized payment processors. We do not collect or store your payment details (e.g., credit card information, bank account details). All billing and payment processing is managed exclusively by the third-party payment provider, and we only receive confirmation of your subscription status.
- We may collect basic information related to your subscription, such as transaction identifiers or account references provided by the payment processor, solely to verify and manage your premium access and entitlements.
...
- We may collect data about application usage and performance, including crash reports and diagnostic information, through third-party services such as Microsoft Clarity. This information is used solely to identify and resolve technical issues, improve app stability, and enhance the user experience.

### d. User-Provided Content

- Any data you input into the App, such as backlog lists, notes, or preferences. By default, all user-generated content is stored locally on your device.
- If you choose to enable cloud synchronization or backup features, your data may be stored in Firebase Firestore for device syncing purposes and in our cloud backup service (Null Ptr Service) for temporary cloud backups. Cloud storage is entirely optional and only occurs when you explicitly enable these features.
...
- To enable optional cloud backups and data synchronization through Firebase Firestore and our Null Ptr Service for temporary cloud backups.
- To process and manage premium subscriptions through third-party payment providers.
- To improve the App, fix bugs, identify crashes, and analyze usage trends through analytics and diagnostic services such as Microsoft Clarity.
...
- **With Third-Party Services:** When you enable cloud synchronization or backup features, your data is shared with Firebase Firestore for device syncing and our Null Ptr Service for temporary cloud backups, in accordance with their respective privacy policies and terms of service.
- **Service Providers:** We use trusted third-party service providers for analytics, diagnostics, hosting, and payment processing, including but not limited to:
  - Microsoft Clarity for crash reporting and usage analytics
  - Firebase (Google) for cloud storage and synchronization
...
We implement reasonable security measures to protect your information from unauthorized access, loss, or alteration. However, no method of transmission or storage is completely secure. Cloud backups and synchronization via third-party services are subject to their respective security practices.

By default, all user-generated backlog data is stored locally on your device, where it remains under your direct control. If you choose to enable cloud synchronization or backup features, your data is encrypted in transit using industry-standard protocols (e.g., TLS/SSL) and stored on secure servers maintained by Firebase Firestore and our Null Ptr Service. We recommend using device-level security features (e.g., passcodes, biometric authentication) to protect locally stored data.
